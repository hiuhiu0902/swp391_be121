...
public class QuitPlanService {
    ...
    public PlanResponse createPlan(PlanRequest planRequest) {
        ...
        planResponse.setTaperingSchedule(taperingSchedule);
        planResponse.setTips(suggestTips(triggers));
        planResponse.setStartDate(planRequest.getStartDate());
        planResponse.setDailyCost(plan.getDailyCost());
        planResponse.setWeeklyCost(plan.getWeeklyCost());
        planResponse.setMonthlyCost(plan.getMonthlyCost());
        planResponse.setYearlyCost(plan.getYearlyCost());
    ...
    public PlanResponse getCurrentUserPlan() {
        Account account = authenticationService.getCurrentAccount();
